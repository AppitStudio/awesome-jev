...
- [Jev Belay](https://github.com/valentynkit/jev-belay) - Claude Code Stop hook that combines local check evidence with Jev judgments to flag unverified completion claims. [Project guide](community/projects/tools/jev-belay.md).
- [Jev Commit](https://github.com/valentynkit/jev-commit) - Commit-message and staged-diff judgments with a local credential scanner; live use is blocked from recommendation pending an upstream upload fix. [Project guide](community/projects/tools/jev-commit.md).
...
- [jev.nvim](https://github.com/valentynkit/jev.nvim) - Scores functions against a question and returns a ranked Neovim quickfix list. [Project guide](community/projects/tools/jev-nvim.md).
