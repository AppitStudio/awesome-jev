...
- [similarity-ts-jev](https://github.com/kongyo2/similarity-ts-jev) - Runs similarity-ts and fallow on TypeScript, then filters pairs with TypeSafe Jev down to refactor-worthy families. [Project guide](community/projects/tools/similarity-ts-jev.md).
