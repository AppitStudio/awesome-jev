...
- [Jevidence](https://github.com/peakevergreen/jevidence) - Python issue-routing sandbox that separates typed Jev judgments from advisory policy, with offline fixtures, threshold checks, and an optional Kev backend. [Project guide](community/projects/tools/jevidence.md).
