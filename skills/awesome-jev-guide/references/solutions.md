...
| Build a search interface with semantic source selection | [Jev Search](https://github.com/AppitStudio/awesome-jev/blob/main/community/projects/apps/jev-search.md) | Search1API and TypeSafe are separate dependencies; results are selected and ranked, not fact-checked or turned into generated answers. |
